...
group_img_url = 'https://i.imgur.com/GuAB8OE.jpg'
#group_img_url = 'url of your own group picture'


faces = CF.face.detect(group_img_url, attributes="age")
# print('faces:')
# print(faces)
...
# set font
showage = str(int(face['faceAttributes']['age']))
largefont = ImageFont.truetype("calibri.ttf", 30)
draw = ImageDraw.Draw(group_img)
imgWidth = face['faceRectangle']['width']/2 - 5
draw.text((face['faceRectangle']['left']+imgWidth, face['faceRectangle']['top']-30), showage,
